...
// const initialState: OrdersState = { byId: {}, allIds: [] }
...
// export const selectAllOrders = (state: any) => state.orders.allIds.map((id: string) => state.orders.byId[id])
// export const selectOrderById = (state: any, id: string) => state.orders.byId[id]
